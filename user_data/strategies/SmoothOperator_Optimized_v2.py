...
# Optimized SmoothOperator v2 with Improved Exit Logic and Hyperopt Parameters
# Based on original by Gert Wohlgemuth


class SmoothOperator_Optimized_v2(IStrategy):
    """

    author@: Gert Wohlgemuth (Original)
    optimized@: AI Assistant v2
    ...
    # CCI thresholds
    cci_oversold = IntParameter(-250, -150, default=-200, space="buy")
    cci_overbought = IntParameter(150, 250, default=200, space="sell")
    
    # MFI thresholds
    mfi_oversold = IntParameter(10, 30, default=30, space="buy")
    mfi_overbought = IntParameter(70, 90, default=80, space="sell")
    
    # Moving average periods
    sma_fast_period = IntParameter(20, 60, default=50, space="buy")
    sma_medium_period = IntParameter(80, 120, default=100, space="buy")
    sma_slow_period = IntParameter(180, 220, default=200, space="buy")
    
    # Exit logic parameters
    exit_rsi_threshold = IntParameter(70, 85, default=80, space="sell")
    exit_cci_threshold = IntParameter(150, 250, default=200, space="sell")
    exit_mfi_threshold = IntParameter(75, 90, default=85, space="sell")
    
    # Market condition parameters
    bullish_threshold = DecimalParameter(1.03, 1.08, default=1.05, space="sell")
